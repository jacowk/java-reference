 ...
 */
public class JTableClassBasedRendererExample extends WindowDecorator{

	public JTableClassBasedRendererExample(Window decoratedWindow){
		super(decoratedWindow);
		JTable table = new JTable(new MyTableModel(createData()));
		table.setPreferredScrollableViewportSize(new Dimension(500, 70));
        table.setFillsViewportHeight(true);
        
        //Set the renderer for all cells
        table.setDefaultRenderer(Color.class, myRenderer);
	...
	public class MyRenderer extends JLabel implements TableCellRenderer{
		...
		private Color notSelectedColor = Color.YELLOW;
