...
public class JSpinnerListModelWithCustomEditorRendererExample extends WindowDecorator implements ChangeListener{

	public JSpinnerListModelWithCustomEditorRendererExample(Window decoratedWindow){
